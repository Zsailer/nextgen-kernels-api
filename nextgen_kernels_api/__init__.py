...
def _load_jupyter_server_extension(serverapp: ServerApp):
    ...
    Kernel client connection and lifecycle management is now handled automatically
    by the kernel managers in their post_start_kernel() and cleanup_resources() methods.
    No separate client manager is needed.
    """
    serverapp.log.info("Next Generation Kernels API extension loaded")
